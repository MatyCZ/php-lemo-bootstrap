...
namespace Lemo\Bootstrap\Form\View\Helper\Captcha;
...
use Lemo\Bootstrap\Form\View\Helper\FormControlHelpBlock;
use Lemo\Bootstrap\Form\View\Helper\FormControlLabel;
use Lemo\Bootstrap\Form\View\Helper\FormGroupElement;

class Image extends AbstractWord
{
    protected ?FormControlLabel $helperControlLabel = null;
    protected ?FormGroupElement $helperGroupElement = null;
    protected ?FormControlHelpBlock $helperHelpBlock = null;
    protected string $templateCloseTag = '</div>';
    protected string $templateOpenTag = '<div class="form-group form-group-sm%s%s" id="form-group-captcha">';
     ...
     */
    protected function getHelperGroupElement(): FormGroupElement
    {
        if ($this->helperControlLabel) {
     ...
     */
    protected function getHelperHelpBlock(): FormControlHelpBlock
    {
